...
public class AutoRumia : MonoBehaviour //Atenção, Rumia!
{
    public bool CreatingFumo = false;
    public static float FumoIncrease = 2f;
    public static float rumix = 2f;
...
/*    void Start()
    ...
    void Update()
    {
        FumoIncrease = GlobalRumia.RumiaPerSec * rumix;
