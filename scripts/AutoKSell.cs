...
public class AutoKSell : MonoBehaviour //Koakuma Selling
{
    public bool SellingFumo = false;
    public static float CashIncrease = 2f;
    public static float kumix = 2f;
   ...
   /* void Start()
    ...
    void Update()
    {
        CashIncrease = GlobalKSell.KSellPerSec * kumix;
